...
class GABloco:
    ...
    def __init__(self):
        self.proximo_novo = self.numero_blocos()

    def numero_blocos(self) -> int:
        """
        Determina o número atual de blocos no arquivo físico
        :return: o númerode blocos
        """
...
class BlocoRegistrosFixos(BlocoBasico):
    ...
    def __init__(self, comprimento_bloco: int, arquivo: BinaryIO,
        ...
        super().__init__(comprimento_bloco, arquivo)
        self.comprimento_registro = comprimento_registro
